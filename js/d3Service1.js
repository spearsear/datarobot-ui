//wrap d3 code in a d3Service, used in jasmine test to avoid the problem of promise
angular.module('d3_no_promise',[])
    .factory('d3Service1',function(){
      //d3 code copied here, notice the leading ! before the self executing function (SEF)
      //is indeed the negate sign, !function(){}() is actually (function(){})() or ;(function(){})()
      //since !function(){}() will execute function(){}() first, then !undefined
      //will return true but we don't care about the return value of function(){}
      //when we do return object in the SEF, we can not use !, use ; instead 
      !function() {
  var d3 = {
    version: "3.4.11"
  };
